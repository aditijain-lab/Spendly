...
The target test file exists under the tests/ directory (e.g., tests/test_login.py)
The virtual environment is active and dependencies from requirements.txt are installed
You know which specific test file or feature to target (ask if unclear)
